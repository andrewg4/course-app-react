...
import TextInput from "../course/TextInput";
import SelectInput from "../course/SelectInput";
    ...
    return (
        <form>
            ...
            <TextInput name="title" label="Title" value={course.title}
                       onChange={onChange} errors={errors.title}/>
            ...
            <TextInput name="category" label="Category" value={course.category}
                       onChange={onChange} errors={errors.category}/>
